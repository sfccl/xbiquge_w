...
class SancunSpider(scrapy.Spider):
    ...
    def start_requests(self):
        start_urls = ['http://www.778buy.com/377_377082/']
    ...
    def parse_c(self, response):
        ...
        item['preview_page'] = "http://www.778buy.com/377_377082/" + response.css('#bgdiv > table.border_l_r > tbody > tr:nth-child(2) > td > a:nth-child(1)::attr(href)').extract()[0]
        item['next_page'] = "http://www.778buy.com/377_377082/" + response.css('#bgdiv > table.border_l_r > tbody > tr:nth-child(2) > td > a:nth-child(3)::attr(href)').extract()[0]
