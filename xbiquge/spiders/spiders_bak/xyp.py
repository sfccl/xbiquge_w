...
class SancunSpider(scrapy.Spider):
    ...
    url_firstchapter = "https://www.xbiquge.la/0/442/364031.html"
    name_txt = "./novels/逍遥派"
    url_chapters = url_firstchapter[0:29]  #截取字符串包括尾部的正斜杠
...
#        pdb.set_trace()
    ...
    def parse_c(self, response):
        ...
        if self.item['url'][29:35] == self.item['next_page'][29:35]: #同一章有分页的处理
