...
class SancunSpider(scrapy.Spider):
    ...
    url_firstchapter = "https://www.xbiquge.la/6/6318/2965642.html"
    name_txt = "./novels/全球高武"
    url_chapters = url_firstchapter[0:30]  #截取字符串包括尾部的正斜杠
...
#        pdb.set_trace()
    ...
    def parse_c(self, response):
        ...
        if self.item['url'][30:37] == self.item['next_page'][30:37]: #同一章有分页的处理
