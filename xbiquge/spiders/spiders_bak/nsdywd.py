...
class SancunSpider(scrapy.Spider):
    name = 'nsdywd'
    allowed_domains = ['www.xbiqupao.com']
    #start_urls = ['https://www.xbiquge.la/10/10489/']
    url_ori= "https://www.xbiqupao.com"
    url_firstchapter = "https://www.xbiqupao.com/book/62980/4734002.html"
    name_txt = "./novels/南宋第一卧底"
...
#        pdb.set_trace()
    ...
    def parse_c(self, response):
        ...
        self.item['preview_page'] = self.url_ori + response.css('div .bottem1 a::attr(href)').extract()[0]
        self.item['next_page'] = self.url_ori + response.css('div .bottem1 a::attr(href)').extract()[2]
